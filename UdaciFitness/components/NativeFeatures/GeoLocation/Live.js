    ...
    setLocation=() => {
        ...
        Location.watchPositionAsync({
            ...
            if(direction !== newDirection) {
                Animated.sequence([
                    Animated.timing(bounceValue, {toValue: 1.4, duration: 200}),
        ...
        if(status==='denied'){
            return (
                <View style={styles.center}>
                    ...
                    <Text>You denied your location.You can fix this by going to settings and enabling location services for this app</Text>
                </View>
            )
        }
               ...
               <View style={styles.directionContainer}>
                ...
                <View style={styles.metricContainer}>
                    <View style={styles.metric}>
                        ...
                        <Text style={[styles.subHeader, {color:white}]}>{Math.round(coords.altitude * 3.2888)} Feet </Text>
                    </View>
                    <View style={styles.metric}>
